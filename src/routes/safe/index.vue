<template>
  <div class='box safe'>
    <p class='topTitle bold'>工厂安全环保管理驾驶舱</p>
    <div class='content'>
      <div class='leftCont'>
        <div class='tabHead'>
          <div class='tabItems'>
          ...
          <div class='tabList'>
            <p>
              本年事故
              <span class='bold'>{{monthOpts.accidentNum}}</span>
            </p>
            <p>
              本年隐患
              <span class='bold'>{{monthOpts.hiddenDangerNum}}</span>
            </p>
          </div>
        </div>
        <div class='charts'>
          <div class='chartBox'>
            <p class='chartTitle bold'>本月安全原因分析</p>
            <Radar />
          </div>
          <div
            class='chartBox'
            style='width: 440px;'
          >
            <p class='chartTitle bold'>每月事故趋势 (近1年)</p>
            <AccidentTender />
          </div>
          <div class='chartBox'>
            <p class='chartTitle bold'>本月隐患原因分析</p>
            <HiddenDangerAnalyse />
          </div>
          <div
            class='chartBox'
            style='width: 440px;'
          >
            <p class='chartTitle bold'>每月隐患数量 (近1年)</p>
            <HiddenDanger />
          </div>
        </div>
      </div>
