		...
		<div class="head">
			<div class="headTab">
				...
				<div class="showNum">
					...
					<img src='../../assets/safe/upOrange.svg' v-if='monthRes.safePoint>monthRes.lastSafePoint' />
					<img v-else src='../../assets/safe/downOrange.svg' />
					<p>同比增长{{monthRes.safeChangePer}}%</p>
				</div>
				<p class="lastNum">
					上月得分：{{monthRes.lastSafePoint.toFixed(2)}}
				</p>
			</div>
			<div class="headTab">
				<p>本月环保超标率</p>
				<div class="showNum" style="color: #6DD230;">
					<span>{{monthRes.envProtectionPer}}</span>
					<img src='../../assets/safe/upGreen.svg' v-if='monthRes.envProtectionPer>monthRes.lastEnvProtectionPer' />
					<img v-else src='../../assets/safe/downGreen.svg' />
					<p>同比增长{{monthRes.envChangePer}}%</p>
				</div>
				<p class="lastNum" style="color: #6DD230;">
					上月环保超标率：{{monthRes.lastEnvProtectionPer}}%
				</p>
			</div>
		</div>
		<div class="chartCont">
